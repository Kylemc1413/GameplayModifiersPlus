...
namespace GamePlayModifiersPlus.Harmony_Patches
{
    ...
    class NoteBasicCutInfoSOGetBasicCutInfo
    {
            ...
            ref AudioTimeSyncController ____audioTimeSyncController, ref BoxCuttableBySaber ____bigCuttableBySaber, ref BoxCuttableBySaber ____smallCuttableBySaber, NoteBasicCutInfoSO ____noteBasicCutInfo)
        {
            ...
            ____noteBasicCutInfo.GetBasicCutInfo(__instance.noteTransform, __instance.noteData.noteType, (int)__instance.noteData.cutDirection >= 2000? NoteCutDirection.Any : __instance.noteData.cutDirection, saber.saberType, saber.bladeSpeed, cutDirVec, out flag, out flag2, out flag3, out cutDirDeviation);
