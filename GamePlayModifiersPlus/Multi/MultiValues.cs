namespace GamePlayModifiersPlus.Multiplayer
{
    ...
    public class MultiValues
    {
        ...
        public float smallerNotesCooldown = 10f;
        public float largerNotesCooldown = 10f;
        public float randomNotesCooldown = 10f;
        public float instaFailCooldown = 4f;
        public float invincibleCooldown = 15f;
        public float njsRandomCooldown = 10f;
        public float noArrowsCooldown = 10f;
        public float funkyCooldown = 10f;
        public float rainbowCooldown = 10f;
        public float pauseGlobalCooldown = 60f;
        public float bombCooldown = 15f;
        public float fasterCooldown = 15f;
        public float slowerCooldown = 15f;
